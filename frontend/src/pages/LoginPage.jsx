...
export default function LoginPage() {
  ...
  const { mutate: loginUser, isPending } = loginMutation;
        ...
        <section className="relative flex flex-col justify-between border-b border-white/10 lg:border-b-0 lg:border-r px-8 py-12 lg:px-14 lg:py-16">
          ...
          <div className="relative my-12">
            <h1 className="text-6xl sm:text-7xl xl:text-8xl font-black tracking-tighter leading-[0.85]">
              ...
              back,
              <br />
              <span className="italic font-serif text-lime-300">friend.</span>
            </h1>
            <p className="mt-8 max-w-sm text-sm leading-relaxed text-white/40">
              Pick up where you left off. Your partners are still online and
              waiting to talk.
            </p>
          </div>
          ...
          <div className="w-full max-w-md">
            ...
            >
              ...
              <div className="flex justify-end -mt-2">
                <Link
                  to="/forgot-password"
                  className="font-mono text-[10px] uppercase tracking-[0.2em] text-white/40 hover:text-lime-300 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
